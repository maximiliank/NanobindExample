...
find_library(
  ...
  PATHS ${ARROW_SEARCH_LIB_PATH}
  NO_DEFAULT_PATH)
message(STATUS "Found ${PARQUET_LIB} in ${ARROW_SEARCH_LIB_PATH}")
...
get_filename_component(PARQUET_SONAME ${PARQUET_LIB} NAME)

add_library(arrow::parquet SHARED IMPORTED)
set_target_properties(
  arrow::parquet
  PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${ARROW_INCLUDE_DIR}"
             IMPORTED_LOCATION "${PARQUET_LIB}"
             IMPORTED_SONAME "${PARQUET_SONAME}")
...
set_target_properties(
  ...
  PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${ARROW_INCLUDE_DIR}"
             ...
             INTERFACE_LINK_LIBRARIES arrow::parquet)
